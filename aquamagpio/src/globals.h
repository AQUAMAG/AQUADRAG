...
const char DEBUG_SPEED_ACTUAL[]     PROGMEM = "Motor speed actual : ";
const char DEBUG_SPEED_GLOBAL[]     PROGMEM = "Motor speed global : ";
const char DEBUG_ACTUATOR_SPEED[]   PROGMEM = "Actuator speed     : ";
const char DEBUG_CURRENT[]          PROGMEM = "Current            : ";
const char DEBUG_MCRSTPS_GLBL[]     PROGMEM = "Microsteps global  : ";
const char DEBUG_MCRSTPS_DRVR[]     PROGMEM = "Microsteps driver  : ";
const char DEBUG_MAX_SPEED[]        PROGMEM = "Max speed          : ";
const char DEBUG_ANGLE[]            PROGMEM = "Angle              : ";
const char DEBUG_FREE_MEMORY[]      PROGMEM = "Free memory        : ";
const char DEBUG_DRIVER_VERSION[]   PROGMEM = "Driver version     : ";
